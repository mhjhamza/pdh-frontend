...
import PatientTable from "../PatientTable/Table";
...
function SimpleDialog(props) {
  ...
  return (
    <Dialog
      ...
      sx={{
        "& .MuiDialog-container": {
          "& .MuiPaper-root": { width: "100%", maxWidth: "1380px" },
        },
      }}
    >
...
export default function SimpleDialogDemo() {
  ...
  const columns = [
    ...
    { title: "HCC Code", field: "cms_hcc_model_category_v24", minWidth: 170, align: "center" },
    { title: "Updated HCC Code", field: "updated_hcc_code", minWidth: 170, align: "center" },
    {
